...
area_light('key', (0, 2.4, 4.2), (math.radians(-26), 0, 0), W * 1.3, 2.2, 700)
area_light('fill', (0, -2.6, 2.8), (math.radians(33), 0, 0), W * 1.0, 2.0, 160, (0.9, 0.93, 1.0))
area_light('rim_l', (-W * 0.7, 0.5, 1.2), (0, math.radians(-58), 0), 1.2, 3.2, 240)
area_light('rim_r', (W * 0.7, 0.5, 1.2), (0, math.radians(58), 0), 1.2, 3.2, 240)
