export const homePl = {
  ...
  how: {
    ...
    h2: 'Nie za kolejny projekt do pilnowania.',
  ...
  offer: {
    ...
    say2: 'Na pierwszej rozmowie powiem Ci też, czy wystarczy jedna konkretna strona, czy potrzebujesz większej witryny. Nie musisz rozstrzygać tego przed kontaktem.',
    ...
    forWhom: 'Dla osób, które wiedzą już, że potrzebują strony i chcą po prostu dobrze dowieźć ten temat.',
