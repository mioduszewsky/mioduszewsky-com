...
export const servicesIndex = {
  pl: {
    ...
    label: 'Usługi',
    h1a: 'Cztery rzeczy,',
    h1b: 'które mogę zbudować.',
    lead: 'Każdy zakres wyceniam osobno. Nie wiesz, który jest Twój? Umów 15 minut — powiem Ci wprost, czego potrzebujesz, a czego nie.',
  ...
  en: {
    ...
    label: 'Services',
    h1a: 'Four things',
    h1b: 'I can build for you.',
    lead: 'Each scope is priced on its own. Not sure which one is yours? Book 15 minutes — I will tell you straight what you need and what you do not.',
